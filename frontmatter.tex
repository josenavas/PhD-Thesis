...
\begin{abstract}
	...
	limits of existing analysis tools, creating a fast-changing environment in which
	new tools are constantly being released. This presents a challenge to
	researchers, which need to constantly learn new analytical tools, expose
	themselves to new environments such as cloud computing or a supercomputer
	cluster, and deal with the problems resulting from a heterogeneous environment
	...
	the first gold standard for analyzing microbiome data, improvements in analytical tools,
	...
	for which the microbiome is becoming a key aspect.
